...
from unitfield.core.types import DEFAULT_CACHE_SIZE, DEFAULT_DTYPE, MAX_CACHE_SIZE
...
class TestTypes:
    ...
    def test_constants(self):
        ...
        assert np.float32 == DEFAULT_DTYPE
...
class TestNumpyInterpolation:
    ...
    def test_edge_handling(self, sample_data_2d):
        ...
        for _method_name, interp_func in np_interp_dict.items():
